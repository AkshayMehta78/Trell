 ...
 */
public class AddTrellImage extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (item.getItemId()) {
            case R.id.action_next:
                ...
                if(null!=description && description.isEmpty()) {
                    ...
                    if (count == 1){
                        imagePath = adapter.getSelectedImage();
                    } else if (count>1){
                        flag = false;
                ...
                if(flag) {
                    ...
                    intent.putExtra(Constants.LOCATIONKEYS.GEOCHATIMAGE,imagePath);
                    setResult(Constants.TRELL.ACTION_IMAGE_ID, intent);
                    finish();
                }
                return true;
